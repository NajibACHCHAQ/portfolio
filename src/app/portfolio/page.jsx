...
const items = [
  ...
  },
  {
    ...
    desc: "Ce projet a pour but de proposer une solution e-commerce permettant au client de poster leurs avis sur les produits, le paiement est disponible via stripe, l interface permet à l administrateur de la boutique de gerer les commandes et les produits ainsi que d'avoir des statistiques sur les ventes sous forme de graphique ",
  ...
  },
  {
    ...
    title: "Gestion de Stock App",
    desc: "Ce projet a pour but d offrir un outils de gestion de stock il se compose d'une API développé en JAVA avec Spring-boot dont la documentation à été généré avec Swagger et dont l'interface utilisateur à été développé avec Angular",
          ...
          >
            ...
            <text fill="#000">
              <textPath xlinkHref="#circlePath" className="text-xl">
                Vous avez un Projet ? ..  N&apos;hésitez Pas ! ..
              </textPath>
            </text>
          </motion.svg>
          <Link
